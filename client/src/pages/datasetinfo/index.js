...
function DatasetInfo() {
  ...
  useEffect(() => {
    const getDataset = async () => {
      try {
        await axios.get(`${process.env.REACT_APP_BACKEND_URI}api/ckan/package_show`, { params: { datasetName: datasetName }, headers: { Authorization: token } }).then((response) => {
          ...
          // setOrganization_id(tmp.organization_id);
