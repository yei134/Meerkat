...
const Content = ({datasetName}) => {
  ...
  return(
    <div className="edit-flex-container">
      <ConLeft owner_org={owner_org} datasetTitle={title} groups={groups}/>
      <div className="form-container">
        <div>
          <span className="edit-title-style"><EditIcon/>&nbsp;Modify&nbsp;Dataset&nbsp;Information</span>
          <hr/>
        </div>
        <form>
          <div>
          ...
          <div>
            <span>&nbsp;Title：<font className="edit-must-fill">&#8251;必填</font></span>
